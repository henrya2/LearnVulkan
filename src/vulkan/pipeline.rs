...
pub fn create_pipeline(
    ...
    */
    ...
    // A negative viewport height flips framebuffer Y to match DirectX NDC orientation.
    // This reverses framebuffer winding, so front faces that were CCW in NDC become CW
    // in framebuffer coordinates. We use CLOCKWISE here to compensate.
